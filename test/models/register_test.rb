...
class RegisterTest < ActiveSupport::TestCase
    ...
    test "PU30 - Create_register_with_over_10_photos" do
    ...
    test "PU34 - Create_register_but_already_exists" do
