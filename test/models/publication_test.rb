...
class PublicationTest < ActiveSupport::TestCase
    ...
    # PU48
    test "Create_publication_on_artist" do
    ...
    # PU49
    test "Create_publication_on_unaccepted_artist" do
    ...
    # PU50
    test "Create_publication_on_event" do
    ...
    # PU51
    test "Create_publication_on_unaccepted_event" do
    ...
    # PU52
    test "Create_publication_with_over_4_photos" do
    ...
    # PU53
    test "Create_publication_with_over_500_characters" do
    ...
    # PU54
    test "Create_publication_without_text" do
