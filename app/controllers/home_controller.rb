class HomeController < ApplicationController
  ...
  def index
    ...
    events_api = TicketmasterService.events_by(query: nil, artist_id: nil, first_date: nil, second_date: nil, country_code: current_user&.ubication&.country&.code, size: 100)
